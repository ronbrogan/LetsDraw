...
namespace LetsDraw.Rendering.Models
{
    public class Triangle : Model
    {
        public void Create()
        {
            ...
            {
                //new VertexFormat(new Vector3(0.25f, -0.25f, 0f), new Vector4(1, 0, 0, 1)),
                //new VertexFormat(new Vector3(-0.25f, -0.5f, 0f), new Vector4(0, 1, 0, 1)),
                //new VertexFormat(new Vector3(0.25f, 0.25f, 0f), new Vector4(0, 0, 1, 1))
            };
